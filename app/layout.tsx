...
export const metadata: Metadata = {
  ...
  alternates: {
    types: {
      "application/rss+xml": [
        { url: "/rss.xml", title: "Obike Emmanuel — Blog RSS" },
      ],
    },
  },
};
    ...
    <html lang="en" suppressHydrationWarning>
      <body className="min-h-screen bg-white text-slate-900 antialiased dark:bg-slate-950 dark:text-slate-100">
        <ThemeProvider attribute="class" defaultTheme="system" enableSystem>
          <a
            href="#main"
            className="sr-only focus:not-sr-only focus:absolute focus:top-2 focus:left-2 focus:bg-emerald-600 focus:text-white focus:px-3 focus:py-2 focus:rounded"
          >
            Skip to content
          </a>
          <Navbar />
